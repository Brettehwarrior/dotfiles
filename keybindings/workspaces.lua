...
-- Resize window w/ keyboard
resizeFactor = 50
hl.bind(mainMod .. " + U", hl.dsp.window.resize({x = -resizeFactor, y = 0, relative = true}), {repeating = true})
hl.bind(mainMod .. " + I", hl.dsp.window.resize({x = 0, y = -resizeFactor, relative = true}), {repeating = true})
hl.bind(mainMod .. " + O", hl.dsp.window.resize({x = 0, y = resizeFactor, relative = true}), {repeating = true})
hl.bind(mainMod .. " + P", hl.dsp.window.resize({x = resizeFactor, y = 0, relative = true}), {repeating = true})
